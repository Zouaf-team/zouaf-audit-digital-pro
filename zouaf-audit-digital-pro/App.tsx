          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-20 text-center">
              ...
              <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
                ...
                <img src="/bpifrance.png" alt="Logo Bpifrance" className="h-32 md:h-20 object-contain" />
                <img src="/reservewithgoogle.png" alt="logo google-reserve" className="h-32 md:h-20 object-contain" />
                <img src="/creditmutuel.png" alt="logo credit mutuel" className="h-32 md:h-20 object-contain" />
                <img src="/latribune.png" alt="logo la tribune" className="h-32 md:h-20 object-contain" />
                <img src="/capital.png" alt="logo capital" className="h-32 md:h-20 object-contain" />
                <img src="/ledauphinelibere.png" alt="logo le dauphiné libéré" className="h-32 md:h-20 object-contain" />
                <img src="/grainedeboss.png" alt="logo graine de boss" className="h-32 md:h-20 object-contain" />
              </div>
            </div>
